...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.roughness_lr = 0.0025  # 0.0002 in GaussianShader
        self.tint_lr = 0.0025  # 0.0002 in GaussianShader
        self.brdf_mlp_lr_init = 1e-2
        self.brdf_mlp_lr_final = 1e-3
        self.brdf_mlp_lr_delay_mult = 0.01
        self.brdf_mlp_lr_max_steps = 30_000
        self.fix_brdf_lr = False
        self.clip_envmap = True
        ...
        self.lambda_alpha = 1.0  # 0.1 seems to work better but try lower
        self.opacity_cull = 0.05  # 0.05 in 2DGS
        self.mask_loss_from_iter = 0
        self.mask_loss_until_iter = 7000
        self.lambda_alpha_drop_factor = 0.8
        self.normal_reg_from_iter = 0
        self.dist_loss_from_iter = 3000
        self.residual_from_iter = 30_000
        self.warmup_until_iter = 0
        self.dilate_mask = False
        ...
        self.env_scope_attribute = "glossiness" # roughness or specular
        self.lambda_env_scope = 0.0
